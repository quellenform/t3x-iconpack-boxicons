...
namespace Quellenform\IconpackBoxicons\Configuration;

/*
 * This file is part of the "iconpack_boxicons" Extension for TYPO3 CMS.
 *
...
class IconpackConfiguration implements IconpackConfigurationInterface
{
    ...
    public function configureIconpack(string $iconpackIdentifier, array $configuration): array
    {
        ...
        $stylesEnabled = (string) trim($extConf->get('iconpack_boxicons', 'stylesEnabled'));
